...
const clnt = UdpStream.create({ objectMode: true });
const svr = UdpStream.create({ objectMode: true });

const initial = UdpStream.createPacket(Buffer.from('hello'));
const response = UdpStream.createPacket(Buffer.from('hi there'));
